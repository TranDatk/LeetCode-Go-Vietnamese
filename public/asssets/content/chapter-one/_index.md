...
Thu hoạch lớn nhất từ ACM-ICPC chính là rèn luyện được tư duy, và khả năng này cũng được áp dụng rất nhiều trong cuộc sống. Thứ hai là được gặp gỡ rất nhiều tuyển thủ thông minh trong nước, từ đó thấy rõ khoảng cách giữa bản thân và họ. Cuối cùng là hơn 200 trang [template thuật toán](https://github.com/halfrost/leetcode-go/releases/tag/Special) được in dày đặc, mà có những phần đến nay tác giả vẫn chưa hoàn toàn hiểu hết.  
...
Toàn bộ code đều được đặt trong [github repo](https://github.com/halfrost/leetcode-go/tree/master/leetcode), có thể tìm bài theo số thứ tự câu hỏi.  
...
[LeetCode](https://leetcode.com/) và [LeetCode Trung Quốc](https://leetcode-cn.com/)
