...
![](/images/chuong-4/rectangle_area_ii_pic.png)
...
- 具体做法，先把各个矩形在 Y 轴方向上离散化，这里的**线段树叶子节点不再是一个点了，而是一个区间长度为 1 的区间段**。
    ...
    ![](/images/chuong-4/leetcode_850_0.png)
...
- 扫描每一个扫描线，先 pushDown 到叶子节点，再 pushUp 到根节点。
    ...
    ![](/images/chuong-4/leetcode_850_3.png)

    ![](/images/chuong-4/leetcode_850_4.png)

    ![](/images/chuong-4/leetcode_850_5.png)

    ![](/images/chuong-4/leetcode_850_6.png)

- 遍历到倒数第 2 根扫描线的时候就能得到结果了。因为最后一根扫描线 update 以后，整个线段树全部都归为初始化状态了。

    ![](/images/chuong-4/leetcode_850_7.png)
